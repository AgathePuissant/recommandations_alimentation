# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 17:20:30 2020
...
class System() :
    ...
    def __init__(self, nbre_user, nbre_jour, seuil_nutri = 70, alpha = 1.005, beta = 1.002, omega = 0.1, seuil_recom = 5, seuil_acc = 0.5, pas_modif = 0.01) :
        ...
        self.regles = pd.read_csv("Base_Mini_Systeme/regles.csv", sep = ";", encoding = 'latin-1')
        
        # Création de table de préférence
        self.tab_pref = pd.read_csv('Base_Mini_Systeme/preference_consommation.csv', sep = ";", encoding = 'latin-1')
        
        # Score de nutrition
        self.score_nutri = pd.read_csv('Base_Mini_Systeme/scores_sainlim_ssgroupes.csv',sep=';', encoding="latin-1")
        
        # Score par contextes :
        self.score_contexte = pd.read_csv('Base_Mini_Systeme/score_par_contextes.csv', sep = ';', encoding="latin-1")
...
def add_user(nbre_user) :
    ...
    train_global_df = pd.read_csv("Base_Mini_Systeme/base_entrainement.csv", sep = ";", encoding = "latin-1")
    ...
    train_global_df.to_csv("Base_Mini_Systeme/base_entrainement.csv", sep = ";", encoding = "latin-1", index = False)
    
#train_df = entrainement_systeme(10)
#train_df.to_csv("Base_Mini_Systeme/base_entrainement.csv", sep = ";", encoding = "latin-1", index = False)
# =============================================================================
